...
GLuint shader;
GLuint vaos[4] = {tailsVAO, chessVAO, sonicVAO, knucklesVAO};
...
glm::mat4 renderShadowMap(lightInstance light)
{
    ...
    lightTransform = glm::perspective(90.0f,       // fov
                                      1.0f,                      // aspect ratio
                                      0.1f,                      // near plane
                                      100.0f);                   // far plane
...
void render()
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    // draw the shadow map
    glm::mat4 lightTransform = renderShadowMap(lights[1]);
