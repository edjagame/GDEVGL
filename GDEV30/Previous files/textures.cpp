...
GLFWwindow *pWindow;
GLuint firstTexture, secondTexture;
float aspectRatio = WINDOW_WIDTH/WINDOW_HEIGHT;

// define a vertex array to hold our vertices
float vertices[] =
{
// position (x, y, z),    color (r, g, b),   texCoords1 (s1, t1),   texCoords1 (s2, t2), 
-0.80f, -0.80f, 0.00f,   0.0f, 1.0f, 1.0f,          -0.0f, -0.0f,
 0.80f, -0.80f, 0.00f,   1.0f, 1.0f, 1.0f,           1.0f, -0.0f,
-0.80f,  0.80f, 0.00f,   1.0f, 1.0f, 1.0f,          -0.0f,  1.0f,
 0.80f,  0.80f, 0.00f,   1.0f, 1.0f, 0.0f,           1.0f,  1.0f,
-0.80f,  0.80f, 0.00f,   1.0f, 1.0f, 1.0f,          -0.0f,  1.0f,
 0.80f, -0.80f, 0.00f,   1.0f, 1.0f, 1.0f,           1.0f, -0.0f,
};
...
bool setup()
{
    ...
    firstTexture = gdevLoadTexture("keqing.png", GL_REPEAT, true, true);
    if (! firstTexture) return false;
    secondTexture = gdevLoadTexture("keqing.png", GL_REPEAT, true, true);
    if (! secondTexture) return false;
    // important: if you have more vertex arrays to draw, make sure you separately define them
    // with unique VAO and VBO IDs, and follow the same process above to upload them to the GPU

    // load our shader program
    shader = gdevLoadShader("textures.vs", "textures.fs");
    if (! shader)
        return false;
...
void render()
{
    ...
    float wave = 1.0 - ((glfwGetTime() - floor(glfwGetTime())) * 2.0 * 3.14);
